        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">¡Bienvenido!</h1>

                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        Soy Lucas, un <span class="font-bold text-orange-400">desarrollador web</span>
                        apasionado por aprender y expandir mis conocimientos. Este proyecto tiene como propósito la
                        <span class="font-bold text-blue-400">creación de un sistema de gestión completo con un dashboard completamente
                            funcional.</span>
                    </p>
